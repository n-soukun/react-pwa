...
const BigBookmark: React.FC<Props> = (props)=>{
    return (
        <a href={props.url} target={props.blank?"_blank":""} className="block transition relative w-full h-auto rounded overflow-hidden hover:shadow-xl hover:shadow-slate-300" rel="noreferrer">
